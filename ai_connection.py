...
Пример вывода:
🚀 Оценка работы: Написание эссе
📌 Критерий 1: Оценка 8 [🟢] + комментарий: В тексте использованы ключевые слова, но не хватает структуры.
📌 Критерий 2: Оценка 7 [🟡] + комментарий: Есть ошибки в грамматике, но общий смысл понятен.
📌 Критерий 3: Оценка 9 [🟢] + комментарий: Логика текста четкая, но можно добавить больше примеров.
💡 Советы для роста:
Ты на верном пути! 🚀 Обрати внимание на структуру текста и добавь больше примеров для усиления аргументации. Не забывай проверять грамматику перед отправкой! ✨

✨ Напоминание: Используй больше связующих слов, чтобы улучшить плавность текста.
